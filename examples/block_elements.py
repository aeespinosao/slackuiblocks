...
def ButtonExamples():
    ...
    # Link button
    link_button = Button(
        text=PlainText(text="Link Button"), url="https://api.slack.com/block-kit"
    )
...
def CheckboxExamples():
    checkbox = CheckboxGroups(
        ...
        initial_options=[Option(value="A1", text=PlainText(text="Checkbox 1"))],
        options=[
            Option(value="A1", text=PlainText(text="Checkbox 1")),
            Option(value="A2", text=PlainText(text="Checkbox 2")),
        ],
    )

    return Section(
        text=PlainText(text="Check out these charming checkboxes"), accessory=checkbox
    )
...
def DatepickerExamples():
    ...
    return Section(
        text=PlainText(text="Pick a date for the deadline."), accessory=datepicker
    )


def DatetimepickerExamples():
    datetimepicker = Datetimepicker(
        action_id="datetime_input", initial_date_time=1628633820
    )
...
def EmailInputExamples():
    email = EmailInput(
        ...
        placeholder=PlainText(text="Enter an email"),
    )
...
def ImageExamples():
    image = Image(
        image_url="http://placekitten.com/700/500", alt_text="Multiple cute kittens"
    )
    ...
    def StaticOptions():
        return Section(
            ...
            accessory=MultiselectStatic(
                ...
                options=[
                    Option(text=PlainText(text="*this is plain_text text*"), value="1"),
                    Option(text=PlainText(text="*this is a markdown text*"), value="2"),
                ],
            ),
        )
    ...
    def UserList():
        return Section(
            ...
            accessory=MultiselectUserList(
                action_id="text12", placeholder=PlainText(text="_Select users_")
            ),
        )
    ...
    def ConversationList():
        return Section(
            ...
            accessory=MultiselectConversationList(
                action_id="text1", placeholder=PlainText(text="Select conversations")
            ),
        )
    ...
    def PublicChannels():
        return Section(
            ...
            accessory=MultiselectPublicChannels(
                action_id="text", placeholder=PlainText(text="Select channels")
            ),
        )
...
def OverflowExamples():
    return Section(
        ...
        accessory=OverflowMenu(
            action_id="overflow",
            options=[
                Option(text=PlainText(text="*this is plain_text text*"), value="3")
            ],
        ),
    )
...
def InputExamples():
    return Input(
        ...
        element=PlainTextInput(
            action_id="plain_input", placeholder=PlainText(text="Enter some plain text")
        ),
    )
...
def RadioButtonExamples():
    return Section(
        ...
        accessory=RadioButton(
            action_id="this_is_an_action_id",
            options=[Option(text=PlainText(text="Radio 1"), value="A1")],
        ),
    )
    ...
    def UserList():
        return Section(
            ...
            accessory=SelectUser(
                action_id="text12", placeholder=PlainText(text="Select user")
            ),
        )
    ...
    def ConversationList():
        return Section(
            ...
            accessory=SelectConversation(
                action_id="text1", placeholder=PlainText(text="Select conversation")
            ),
        )
    ...
    def PublicChannel():
        return Section(
            ...
            accessory=SelectPublicChannel(
                action_id="text", placeholder=PlainText(text="Select channel")
            ),
        )
...
def TimepickerExamples():
    timepicker = TimePicker(
        ...
        initial_date="12:20",
        placeholder=PlainText(text="Select time"),
    )
    return Section(
        text=PlainText(text="Pick a date for the deadline."), accessory=timepicker
    )
